...
// 	const app = justTestApp({ name: 'test' })

// 	const g = import('./test-artifacts/dummy_gizmo.js')
// 	const { Component } = lazyImport(import('./test-artifacts/dummy_gizmo.js'), 'Component', ({ dummyGizmoFn }) =>
// 		app.with(dummyGizmoFn({ a: 1 }))
// 	)
