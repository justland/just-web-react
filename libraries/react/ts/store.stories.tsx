	...
	return (
		<Card>
			<p>
				...
				<p>
					This value is lack behind by one when using `setValue`, because change occurs within `useEffect()` and the
					store value is not tracked by React
				</p>
			</p>
			<p>
		...
		(Story) => (
			<div className="flex flex-col gap-2">
				<Card>
					...
					<p>
						It demonstrates that when the store is updated outside, the component with <code>useStore</code> will be
						re-rendered.
					</p>
				</Card>
